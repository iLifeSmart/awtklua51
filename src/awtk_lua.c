...
//hack by hantianheng
//#define INCLUDE_RLOTTIE
#if (defined INCLUDE_RLOTTIE)
...
//hack by pulleyzzz
static int wrap_assets_manager_preload(lua_State* L) {
  ret_t ret = 0;
  assets_manager_t* am = (assets_manager_t*)tk_checkudata(L, 1, "assets_manager_t");
  asset_type_t asset_type = (asset_type_t)luaL_checkinteger(L, 2);
  const char* name = (const char*)luaL_checkstring(L, 3);
  ret = (ret_t)assets_manager_preload(am, asset_type,name);
...
static int wrap_assets_manager_add_ttf_mmap_font(lua_State* L) {
  ret_t ret = 0;
  assets_manager_t* am = (assets_manager_t*)tk_checkudata(L, 1, "assets_manager_t");
...
//hack by pulleyzzz
static int wrap_widget_get_theme(lua_State* L) {
  const char* ret = NULL;
  assets_manager_t* am = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  am  = (assets_manager_t*)widget_get_assets_manager(widget);
  ret = (const char*)am->theme;
  lua_pushstring(L,(const char*)ret);
  return 1;
}
//hack by pulleyzzz
static int wrap_widget_measure_text(lua_State* L) {
  float w;
  size_t len;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* txt = (const char*)luaL_checklstring(L, 2,&len);
  wchar_t* wtxt=malloc(len*sizeof(wchar_t)+1);
  if (wtxt)
  {
    tk_utf8_to_utf16(txt, wtxt, len*sizeof(wchar_t)+1);
    w=widget_measure_text(widget,wtxt);
    free(wtxt);
  }
  else
  {
...
static int wrap_widget_off_by_tag(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  u_int32_t tag = (int32_t)luaL_checknumber(L, 2);
  ret = (ret_t)widget_off_by_tag(widget, tag);
...
ret_t slide_view_set_active_anim(widget_t* widget, uint32_t active) {
  ...
  if (slide_view->active != active && widget->children != NULL) {
    int dir=(slide_view->active>active)?1:-1;
    ...
    if (slide_view->vertical) {
      widget_animator_scroll_set_params(animator, 0, 0, 0, dir*widget->h);
    } else {
      widget_animator_scroll_set_params(animator, 0, 0, dir*widget->w, 0);
    }
...
static int wrap_slide_view_set_active_anim(lua_State* L) {
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  uint32_t index = (uint32_t)luaL_checkinteger(L, 2);
  ret = (ret_t)slide_view_set_active_anim(widget, index);
...
static widget_t* window_open_with_name_xml(const char* name, widget_t* to_close,const uint8_t* content,size_t size) {
  widget_t* win = ui_loader_load_widget_xml(name,content,size);
...
static int wrap_window_open_xml(lua_State* L) {
  widget_t* ret = NULL;
  const char* name = (const char*)luaL_checkstring(L, 1);
  size_t size;
  const uint8_t* content = (const uint8_t*)luaL_checklstring(L, 2,&size);
  ret = (widget_t*)window_open_with_name_xml(name,NULL,content,size);

  return tk_newuserdata(L, (void*)ret, "/window_t/window_base_t/widget_t", "awtk.window_t");
}
static int wrap_window_open_and_close_xml(lua_State* L) {
  widget_t* ret = NULL;
  const char* name = (const char*)luaL_checkstring(L, 1);
  widget_t* to_close = (widget_t*)tk_checkudata(L, 2, "widget_t");
  size_t size;
  const uint8_t* content = (const uint8_t*)luaL_checklstring(L, 3,&size);
  ret = (widget_t*)window_open_with_name_xml(name,to_close,content,size);
...
static int wrap_tk_set_log_level(lua_State* L) {
  ret_t ret = 0;
  log_level_t ll = (log_level_t)luaL_checkinteger(L,1);

  ret = (ret_t)log_set_log_level(ll);
...
static int wrap_tk_get_log_level(lua_State* L) {
  log_level_t ret = 0;
  ret = log_get_log_level();
...
static int wrap_tk_init_assets(lua_State* L) {
  ret_t ret = 0;
  ret = (ret_t)tk_init_assets();
...
/********************************/
/********************************/
//hack by hantianheng  rlottie start
#if (defined INCLUDE_RLOTTIE)
static int wrap_rlottie_create(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* parent = (widget_t*)tk_checkudata(L, 1, "widget_t");
  xy_t x = (xy_t)luaL_checkinteger(L, 2);
  xy_t y = (xy_t)luaL_checkinteger(L, 3);
  wh_t w = (wh_t)luaL_checkinteger(L, 4);
  wh_t h = (wh_t)luaL_checkinteger(L, 5);
  ret = (widget_t*)rlottie_create(parent, x, y, w, h);

  return tk_newuserdata(L, (void*)ret, "/rlottie_t/widget_t", "awtk.rlottie_t");
}

static int wrap_rlottie_cast(lua_State* L) {
  widget_t* ret = NULL;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  ret = (widget_t*)rlottie_cast(widget);

  return tk_newuserdata(L, (void*)ret, "/rlottie_t/widget_t", "awtk.rlottie_t");
}

static int wrap_rlottie_set_url(lua_State* L){
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  const char* url = (char *)luaL_checkstring(L,2);
  ret = rlottie_set_url(widget,url);
  lua_pushnumber(L, (lua_Number)(ret));
  return 1;
}

static int wrap_rlottie_stop(lua_State* L){
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  ret = rlottie_stop(widget);
  lua_pushnumber(L, (lua_Number)(ret));
  return 1;
}

static int wrap_rlottie_pause(lua_State* L){
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  ret = rlottie_pause(widget);
  lua_pushnumber(L, (lua_Number)(ret));
  return 1;
}


static int wrap_rlottie_play(lua_State* L){
  ret_t ret = 0;
  widget_t* widget = (widget_t*)tk_checkudata(L, 1, "widget_t");
  ret = rlottie_play(widget);
  lua_pushnumber(L, (lua_Number)(ret));
  return 1;
}

static const struct luaL_Reg rlottie_t_member_funcs[] = {
    {"play", wrap_rlottie_play},
    {"stop", wrap_rlottie_stop},
    {"pause",wrap_rlottie_pause},
    {"set_url",wrap_rlottie_set_url},
    {NULL, NULL}};

static int wrap_rlottie_t_set_prop(lua_State* L){
  rlottie_t* obj = (rlottie_t*)tk_checkudata(L, 1, "rlottie_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  (void)obj;
  (void)name;
  return wrap_widget_t_set_prop(L);
...
static int wrap_rlottie_t_get_prop(lua_State* L){
  rlottie_t* obj = (rlottie_t*)tk_checkudata(L, 1, "rlottie_t");
  const char* name = (const char*)luaL_checkstring(L, 2);
  const luaL_Reg* ret = find_member(rlottie_t_member_funcs, name);
  ...
  if (strcmp(name, "url") == 0) {
    ...
    lua_pushboolean(L, (lua_Integer)(obj->running));
    return 1;
  } else if (strcmp(name, "durationms") == 0) {
    lua_pushnumber(L, (lua_Integer)(obj->durationms));
    return 1;
  }else {
    return wrap_widget_t_get_prop(L);
    return 0;
...
static void rlottie_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
      {"create", wrap_rlottie_create}, {"cast", wrap_rlottie_cast}, {NULL, NULL}};

  static const struct luaL_Reg index_funcs[] = {
      {"__index", wrap_rlottie_t_get_prop}, {"__newindex", wrap_rlottie_t_set_prop}, {NULL, NULL}};

  luaL_newmetatable(L, "awtk.rlottie_t");
  lua_pushstring(L, "__index");
  lua_pushvalue(L, -2);
  lua_settable(L, -3);
  luaL_openlib(L, NULL, index_funcs, 0);
  luaL_openlib(L, "Rlottie", static_funcs, 0);
  lua_settop(L, 0);
}
#endif
//hack by hantianheng  rlottie end
/********************************/
...
static void tk_object_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {{"ref", wrap_tk_object_ref}, {NULL, NULL}};

  static const struct luaL_Reg index_funcs[] = {{"__index", wrap_tk_object_t_get_prop},
...
static void global_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {{"init", wrap_tk_init},
                                                 ...
                                                 {"set_log_level", wrap_tk_set_log_level},//hack by pulleyzzz
                                                 ...
                                                 {"set_lcd_orientation",wrap_tk_set_lcd_orientation},//hack by hantianheng
                                                 {NULL, NULL}};
...
static const struct luaL_Reg event_t_member_funcs[] = {
    {"get_type", wrap_event_get_type}, {"destroy", wrap_event_destroy}, {NULL, NULL}};
...
static void event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {{"from_name", wrap_event_from_name},
...
static int wrap_widget_get_native_window(lua_State* L) {
  ...
  return tk_newuserdata(L, (void*)ret, "/native_window_t/tk_object_t/emitter_t",
...
static const struct luaL_Reg widget_t_member_funcs[] = {
    ...
    {"on", wrap_widget_on},
    {"on_with_tag", wrap_widget_on_with_tag}, //hack by pulleyzzz
    {"off", wrap_widget_off},
    {"off_by_tag", wrap_widget_off_by_tag},  //hack by pulleyzzz
...
static void ext_widgets_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {{"init", wrap_tk_ext_widgets_init}, {NULL, NULL}};
...
static const struct luaL_Reg asset_info_t_member_funcs[] = {
    {"get_type", wrap_asset_info_get_type}, {"get_name", wrap_asset_info_get_name}, {NULL, NULL}};
...
static int wrap_offset_change_event_cast(lua_State* L) {
  ...
  return tk_newuserdata(L, (void*)ret, "/offset_change_event_t/event_t",
                        "awtk.offset_change_event_t");
}

static const struct luaL_Reg offset_change_event_t_member_funcs[] = {{NULL, NULL}};
...
static void offset_change_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {{"cast", wrap_offset_change_event_cast},
                                                 {NULL, NULL}};

  static const struct luaL_Reg index_funcs[] = {{"__index", wrap_offset_change_event_t_get_prop},
...
static int wrap_theme_change_event_cast(lua_State* L) {
  ...
  return tk_newuserdata(L, (void*)ret, "/theme_change_event_t/event_t",
                        "awtk.theme_change_event_t");
}

static const struct luaL_Reg theme_change_event_t_member_funcs[] = {{NULL, NULL}};
...
static void theme_change_event_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {{"cast", wrap_theme_change_event_cast},
                                                 {NULL, NULL}};

  static const struct luaL_Reg index_funcs[] = {{"__index", wrap_theme_change_event_t_get_prop},
...
static void color_component_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
      {"create", wrap_color_component_create}, {"cast", wrap_color_component_cast}, {NULL, NULL}};
...
static void gauge_pointer_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
      {"create", wrap_gauge_pointer_create}, {"cast", wrap_gauge_pointer_cast}, {NULL, NULL}};

  static const struct luaL_Reg index_funcs[] = {{"__index", wrap_gauge_pointer_t_get_prop},
...
static const struct luaL_Reg gauge_t_member_funcs[] = {
    {"set_image", wrap_gauge_set_image}, {"set_draw_type", wrap_gauge_set_draw_type}, {NULL, NULL}};
...
static void gauge_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
      {"create", wrap_gauge_create}, {"cast", wrap_gauge_cast}, {NULL, NULL}};

  static const struct luaL_Reg index_funcs[] = {
      {"__index", wrap_gauge_t_get_prop}, {"__newindex", wrap_gauge_t_set_prop}, {NULL, NULL}};
...
static void candidates_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
      {"create", wrap_candidates_create}, {"cast", wrap_candidates_cast}, {NULL, NULL}};
...
static const struct luaL_Reg slide_view_t_member_funcs[] = {
    ...
    {"set_active_anim",wrap_slide_view_set_active_anim}, //hack by pulleyzzz
    {NULL, NULL}};
...
static const struct luaL_Reg vpage_t_member_funcs[] = {{"set_ui_asset", wrap_vpage_set_ui_asset},
...
static void vpage_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
      {"create", wrap_vpage_create}, {"cast", wrap_vpage_cast}, {NULL, NULL}};

  static const struct luaL_Reg index_funcs[] = {
      {"__index", wrap_vpage_t_get_prop}, {"__newindex", wrap_vpage_t_set_prop}, {NULL, NULL}};
...
static const struct luaL_Reg slider_t_member_funcs[] = {
    ...
    {"set_max", wrap_slider_set_max},           {"set_line_cap", wrap_slider_set_line_cap},
    {"set_step", wrap_slider_set_step},         {"set_bar_size", wrap_slider_set_bar_size},
...
static void window_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
	  ...
	  {"open_xml", wrap_window_open_xml},     {"open_and_close_xml", wrap_window_open_and_close_xml},//hack by pulleyzzz
...
static const struct luaL_Reg gif_image_t_member_funcs[] = {{"play", wrap_gif_image_play},
...
static int wrap_mutable_image_create(lua_State* L) {
  ...
  return tk_newuserdata(L, (void*)ret, "/mutable_image_t/image_base_t/widget_t",
                        "awtk.mutable_image_t");
}
...
static void mutable_image_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {{"create", wrap_mutable_image_create},
                                                 {NULL, NULL}};
...
static int wrap_object_array_create(lua_State* L) {
  ...
  return tk_newuserdata(L, (void*)ret, "/object_array_t/tk_object_t/emitter_t",
                        "awtk.object_array_t");
}
...
static int wrap_object_default_create(lua_State* L) {
  ...
  return tk_newuserdata(L, (void*)ret, "/object_default_t/tk_object_t/emitter_t",
...
static int wrap_object_default_t_get_prop(lua_State* L) {
  ...
  if (strcmp(name, "props_size") == 0) {
    lua_pushinteger(L, (lua_Integer)(obj->props.size));
...
static void calibration_win_t_init(lua_State* L) {
  static const struct luaL_Reg static_funcs[] = {
      {"create", wrap_calibration_win_create}, {"cast", wrap_calibration_win_cast}, {NULL, NULL}};
